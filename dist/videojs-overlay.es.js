...
function (_Component) {
  ...
  _proto.hide = function hide() {
    _Component.prototype.hide.call(this); // since there is a bug with removing the video.js event listeners, prevent the function from being called
    // more than once
  ...
  _proto.show = function show() {
    _Component.prototype.show.call(this); // since there is a bug with removing the video.js event listeners, prevent the function from being called
    // more than once
